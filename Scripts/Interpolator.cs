// this was copied from MRTK.
// See https://github.com/Microsoft/MixedRealityToolkit-Unity/blob/master/Assets/HoloToolkit/Common/Scripts/Interpolator.cs for original

// Refactored and updated to allow for interpolating local position
...
namespace FVTC.LearningInnovations.Unity
{
    public class Interpolator : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            UpdateLocalRotation(deltaTime);
            UpdateLocalScale(deltaTime);
        ...
        private void UpdateLocalScale(float deltaTime)
        {
        ...
        private void UpdateLocalRotation(float deltaTime)
        {
